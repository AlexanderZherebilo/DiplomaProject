...
<div class="container"><br>
    <div class="row justify-content-center">
        <form class="col-6 jumbotron" action="/registration" onsubmit="return formValidation();" method="post">
            ...
            <input type="text" name="name" id="inputName" class="form-control" placeholder="Введите реальное имя" title="Используйте только русские символы" pattern="^[а-яА-Я]+$" required autofocus><br>
            <label for="inputName" class="mb-2 mr-sm-2">Фамилия:</label>
            <input type="text" name="surname" id="inputSurname" class="form-control" placeholder="Введите реальную фамилию" title="Используйте только русские символы" pattern="^[а-яА-Я]+$" required><br>
            <label for="inputLogin" class="mb-2 mr-sm-2">Логин:</label>
            <input type="text" name="username" id="inputLogin" class="form-control" placeholder="Логин" title="Используйте только латинские символы и цифры, также символ '_'" minlength="7" pattern="^[a-zA-Z0-9_]+$" required><br>
